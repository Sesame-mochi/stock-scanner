...
# Allow requests from anywhere (required for Claude.ai artifacts)
...
@app.route("/")
def index():
    return jsonify({"status": "ok", "message": "Stock Scanner API is running"})
...
if __name__ == "__main__":
    ...
    print(f"Stock Scanner backend running on port {port}")
